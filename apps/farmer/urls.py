...
from . import views
from .endpoint import get_soil_data
...
urlpatterns = [
    ...
    path(
        "farm-management/delete-farm/<int:farm_id>/",
        views.delete_farm,
        name="delete_farm",
    ),
    path(
        "farm-management/delete-crop/<int:crop_id>/",
        views.delete_crop,
        name="delete_crop",
    ),
    ...
    path(
        "predictions/delete/<int:prediction_id>/",
        views.delete_prediction,
        name="delete_prediction",
    ),
    path(
        "predictions/download/<int:prediction_id>/",
        views.download_prediction_pdf,
        name="download_prediction_pdf",
    ),
    path(
        "predictions/download-csv/",
        views.download_predictions_csv,
        name="download_predictions_csv",
    ),
    path(
        "get-latest-readings/<int:farm_id>/",
        views.get_latest_readings,
    ...
    path(
        "soil-data/delete/<int:reading_id>/",
        views.delete_reading,
        name="delete_reading",
    ),
    path(
